...
public class Consola {
	...
	public static Color elegirOpcion() {
		...
		//Uso color para clarificar el codigo y usar un solo return en vez de 1 por cada color.
		if(opcion == 1) {
			color = Color.BLANCO;
		}else {
			color =Color.NEGRO;
	...
	public static Direccion elegirDireccion() {
		int opcion;
		//Inicializo direccion a null para poder hacer el return ya que debe tener valor, aunque nunca deberia devolver null
		...
		switch (opcion) {
		//Utilizo Direccion.values()[] para que tenga el mismo valor que en el syso de mostrarMenuDirecciones()
			case 1:
